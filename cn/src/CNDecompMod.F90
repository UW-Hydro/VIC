...
!
! !INTERFACE:
subroutine CNDecompAlloc (adspinup, dt, lbp, ubp, lbc, ubc, num_soilc, &
	num_soilp)
!
! !DESCRIPTION:
!
...
!-----------------------------------------------------------------------
   ...
   cwdn_to_litr2n        => clm3%g%c%cnf%cwdn_to_litr2n
   cwdn_to_litr3n        => clm3%g%c%cnf%cwdn_to_litr3n
   potential_immob       => clm3%g%c%cnf%potential_immob
   litr1n_to_soil1n      => clm3%g%c%cnf%litr1n_to_soil1n
   sminn_to_soil1n_l1    => clm3%g%c%cnf%sminn_to_soil1n_l1
   litr2n_to_soil2n      => clm3%g%c%cnf%litr2n_to_soil2n
   sminn_to_soil2n_l2    => clm3%g%c%cnf%sminn_to_soil2n_l2
   litr3n_to_soil3n      => clm3%g%c%cnf%litr3n_to_soil3n
   sminn_to_soil3n_l3    => clm3%g%c%cnf%sminn_to_soil3n_l3
   soil1n_to_soil2n      => clm3%g%c%cnf%soil1n_to_soil2n
   sminn_to_soil2n_s1    => clm3%g%c%cnf%sminn_to_soil2n_s1
   soil2n_to_soil3n      => clm3%g%c%cnf%soil2n_to_soil3n
   sminn_to_soil3n_s2    => clm3%g%c%cnf%sminn_to_soil3n_s2
   soil3n_to_soil4n      => clm3%g%c%cnf%soil3n_to_soil4n
   sminn_to_soil4n_s3    => clm3%g%c%cnf%sminn_to_soil4n_s3
   soil4n_to_sminn       => clm3%g%c%cnf%soil4n_to_sminn
   ...
   gross_nmin            => clm3%g%c%cnf%gross_nmin
   net_nmin              => clm3%g%c%cnf%net_nmin
   ...
   call CNAllocation(dt, lbp, ubp, lbc,ubc,num_soilc,num_soilp)
