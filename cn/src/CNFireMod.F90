...
!
! !INTERFACE:
subroutine CNFireArea (dt, nstep, yr, num_soilc)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   ! PET 5/20/08, test to increase fire area
   totvegc          => clm3%g%c%ccs%pcs_a%totvegc
...
!
! !INTERFACE:
subroutine CNFireFluxes (dt, lbp, ubp, lbc, ubc, num_soilc, num_soilp)
!
! !DESCRIPTION:
...
!#endif
    ...
    m_deadcrootc_to_cwdc_fire      => clm3%g%c%ccf%m_deadcrootc_to_cwdc_fire
    m_deadstemc_to_cwdc_fire       => clm3%g%c%ccf%m_deadstemc_to_cwdc_fire
    ...
    m_deadcrootn_to_cwdn_fire      => clm3%g%c%cnf%m_deadcrootn_to_cwdn_fire
    m_deadstemn_to_cwdn_fire       => clm3%g%c%cnf%m_deadstemn_to_cwdn_fire
    ...
    leafcmax                       => clm3%g%c%p%pcs%leafcmax
    ...
    m_deadcrootn_to_litter_fire    => clm3%g%c%p%pnf%m_deadcrootn_to_litter_fire
    ...
    m_deadstemn_to_litter_fire     => clm3%g%c%p%pnf%m_deadstemn_to_litter_fire
...
!#endif
   ...
   call p2c_1d(lbp, ubp, lbc, ubc, m_deadstemc_to_litter_fire, &
	    m_deadstemc_to_cwdc_fire, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, m_deadcrootc_to_litter_fire, &
	    m_deadcrootc_to_cwdc_fire, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, m_deadstemn_to_litter_fire, &
	    m_deadstemn_to_cwdn_fire, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, m_deadcrootn_to_litter_fire, &
	    m_deadcrootn_to_cwdn_fire, 'unity')
