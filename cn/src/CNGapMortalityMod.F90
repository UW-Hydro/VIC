...
!
! !INTERFACE:
subroutine CNGapMortality (yr, num_soilc, num_soilp)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   m_leafn_to_litter              => clm3%g%c%p%pnf%m_leafn_to_litter
   m_frootn_to_litter             => clm3%g%c%p%pnf%m_frootn_to_litter
   m_livestemn_to_litter          => clm3%g%c%p%pnf%m_livestemn_to_litter
   m_deadstemn_to_litter          => clm3%g%c%p%pnf%m_deadstemn_to_litter
   m_livecrootn_to_litter         => clm3%g%c%p%pnf%m_livecrootn_to_litter
   m_deadcrootn_to_litter         => clm3%g%c%p%pnf%m_deadcrootn_to_litter
   m_retransn_to_litter           => clm3%g%c%p%pnf%m_retransn_to_litter
   m_leafn_storage_to_litter      => clm3%g%c%p%pnf%m_leafn_storage_to_litter
   m_frootn_storage_to_litter     => clm3%g%c%p%pnf%m_frootn_storage_to_litter
   m_livestemn_storage_to_litter  => clm3%g%c%p%pnf%m_livestemn_storage_to_litter
   m_deadstemn_storage_to_litter  => clm3%g%c%p%pnf%m_deadstemn_storage_to_litter
   m_livecrootn_storage_to_litter => clm3%g%c%p%pnf%m_livecrootn_storage_to_litter
   m_deadcrootn_storage_to_litter => clm3%g%c%p%pnf%m_deadcrootn_storage_to_litter
   m_leafn_xfer_to_litter         => clm3%g%c%p%pnf%m_leafn_xfer_to_litter
   m_frootn_xfer_to_litter        => clm3%g%c%p%pnf%m_frootn_xfer_to_litter
   m_livestemn_xfer_to_litter     => clm3%g%c%p%pnf%m_livestemn_xfer_to_litter
   m_deadstemn_xfer_to_litter     => clm3%g%c%p%pnf%m_deadstemn_xfer_to_litter
   m_livecrootn_xfer_to_litter    => clm3%g%c%p%pnf%m_livecrootn_xfer_to_litter
   m_deadcrootn_xfer_to_litter    => clm3%g%c%p%pnf%m_deadcrootn_xfer_to_litter
!#if (defined CNDV)
!   greffic                        => clm3%g%c%p%pdgvs%greffic
!   heatstress                     => clm3%g%c%p%pdgvs%heatstress
!#endif
...
!#endif
      ...
      m  = am/(get_days_per_year(yr) * secspday)
   ...
   call CNGapPftToColumn(num_soilc)
...
!
! !INTERFACE:
subroutine CNGapPftToColumn (num_soilc)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   m_leafn_to_litr1n              => clm3%g%c%cnf%m_leafn_to_litr1n
   m_leafn_to_litr2n              => clm3%g%c%cnf%m_leafn_to_litr2n
   m_leafn_to_litr3n              => clm3%g%c%cnf%m_leafn_to_litr3n
   m_frootn_to_litr1n             => clm3%g%c%cnf%m_frootn_to_litr1n
   m_frootn_to_litr2n             => clm3%g%c%cnf%m_frootn_to_litr2n
   m_frootn_to_litr3n             => clm3%g%c%cnf%m_frootn_to_litr3n
   m_livestemn_to_cwdn            => clm3%g%c%cnf%m_livestemn_to_cwdn
   m_deadstemn_to_cwdn            => clm3%g%c%cnf%m_deadstemn_to_cwdn
   m_livecrootn_to_cwdn           => clm3%g%c%cnf%m_livecrootn_to_cwdn
   m_deadcrootn_to_cwdn           => clm3%g%c%cnf%m_deadcrootn_to_cwdn
   m_retransn_to_litr1n           => clm3%g%c%cnf%m_retransn_to_litr1n
   m_leafn_storage_to_litr1n      => clm3%g%c%cnf%m_leafn_storage_to_litr1n
   m_frootn_storage_to_litr1n     => clm3%g%c%cnf%m_frootn_storage_to_litr1n
   m_livestemn_storage_to_litr1n  => clm3%g%c%cnf%m_livestemn_storage_to_litr1n
   m_deadstemn_storage_to_litr1n  => clm3%g%c%cnf%m_deadstemn_storage_to_litr1n
   m_livecrootn_storage_to_litr1n => clm3%g%c%cnf%m_livecrootn_storage_to_litr1n
   m_deadcrootn_storage_to_litr1n => clm3%g%c%cnf%m_deadcrootn_storage_to_litr1n
   m_leafn_xfer_to_litr1n         => clm3%g%c%cnf%m_leafn_xfer_to_litr1n
   m_frootn_xfer_to_litr1n        => clm3%g%c%cnf%m_frootn_xfer_to_litr1n
   m_livestemn_xfer_to_litr1n     => clm3%g%c%cnf%m_livestemn_xfer_to_litr1n
   m_deadstemn_xfer_to_litr1n     => clm3%g%c%cnf%m_deadstemn_xfer_to_litr1n
   m_livecrootn_xfer_to_litr1n    => clm3%g%c%cnf%m_livecrootn_xfer_to_litr1n
   m_deadcrootn_xfer_to_litr1n    => clm3%g%c%cnf%m_deadcrootn_xfer_to_litr1n
