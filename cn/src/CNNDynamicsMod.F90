...
!
! !INTERFACE:
subroutine CNNDeposition( yr, jdy, lbg, ubg, lbc, ubc )
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   call ndep_interp(yr, jdy, lbg, ubg)

   ! Assign local pointers to derived type arrays (in)
   forc_ndep     => clm_a2l%forc_ndep
   gridcell      => clm3%g%c%gridcell
...
!
! !INTERFACE:
subroutine CNNFixation(yr, num_soilc)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNNLeaching(nlevsoi, dt, lbc, ubc, num_soilc)
!
! !DESCRIPTION:
