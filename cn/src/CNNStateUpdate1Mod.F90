...
!
! !INTERFACE:
subroutine NStateUpdate1(dt, num_soilc, num_soilp)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   ndep_to_sminn                  => clm3%g%c%cnf%ndep_to_sminn
   nfix_to_sminn                  => clm3%g%c%cnf%nfix_to_sminn
   ...
   dwt_seedn_to_leaf              => clm3%g%c%cnf%dwt_seedn_to_leaf
   dwt_seedn_to_deadstem          => clm3%g%c%cnf%dwt_seedn_to_deadstem
   dwt_frootn_to_litr1n           => clm3%g%c%cnf%dwt_frootn_to_litr1n
   dwt_frootn_to_litr2n           => clm3%g%c%cnf%dwt_frootn_to_litr2n
   dwt_frootn_to_litr3n           => clm3%g%c%cnf%dwt_frootn_to_litr3n
   dwt_livecrootn_to_cwdn         => clm3%g%c%cnf%dwt_livecrootn_to_cwdn
   dwt_deadcrootn_to_cwdn         => clm3%g%c%cnf%dwt_deadcrootn_to_cwdn
   ...
   grainn_storage_to_xfer         => clm3%g%c%p%pnf%grainn_storage_to_xfer
   grainn_to_food                 => clm3%g%c%p%pnf%grainn_to_food
   grainn_xfer_to_grainn          => clm3%g%c%p%pnf%grainn_xfer_to_grainn
