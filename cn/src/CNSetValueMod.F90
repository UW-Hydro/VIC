...
!
! !INTERFACE:
subroutine CNZeroFluxes(num_filterc, num_filterp)
!
! !DESCRIPTION:
!
! !USES:
...
!-----------------------------------------------------------------------
    ...
    call CNSetCcf(num_filterc, 0._r8, clm3%g%c%ccf)
    call CNSetCnf(num_filterc, 0._r8, clm3%g%c%cnf)

    ! zero the column-average pft-level C and N fluxes
    call CNSetPcf(num_filterc, 0._r8, clm3%g%c%ccf%pcf_a)
    call CNSetPnf(num_filterc, 0._r8, clm3%g%c%cnf%pnf_a)

    ! zero the pft-level C and N fluxes
    call CNSetPcf(num_filterp, 0._r8, clm3%g%c%p%pcf)
    call CNSetPnf(num_filterp, 0._r8, clm3%g%c%p%pnf)
...
!
! !INTERFACE:
subroutine CNSetPps(num, val, pps)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetPepv (num, val, pepv)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetPcs (num, val, pcs)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetPns(num, val, pns)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetPcf(num, val, pcf)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetPnf(num, val, pnf)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetCps(nlevgrnd, num, val, cps)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetCcs(num, val, ccs)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetCns(num, val, cns)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetCcf(num, val, ccf)
!
! !DESCRIPTION:
...
!
! !INTERFACE:
subroutine CNSetCnf(num, val, cnf)
!
! !DESCRIPTION:
