...
! 10/15/12: Adapted for use in VIC by Michael Brunke
...
!
! !INTERFACE:
subroutine CSummary(lbp, ubp, lbc, ubc, num_soilc, num_soilp)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ! assign local pointers
    ...
    col_fire_closs                 => clm3%g%c%ccf%col_fire_closs
    er                             => clm3%g%c%ccf%er
    hr                             => clm3%g%c%ccf%hr
    litfire                        => clm3%g%c%ccf%litfire
    lithr                          => clm3%g%c%ccf%lithr
    litr1_hr                       => clm3%g%c%ccf%litr1_hr
    litr2_hr                       => clm3%g%c%ccf%litr2_hr
    litr3_hr                       => clm3%g%c%ccf%litr3_hr
    m_cwdc_to_fire                 => clm3%g%c%ccf%m_cwdc_to_fire
    m_litr1c_to_fire               => clm3%g%c%ccf%m_litr1c_to_fire
    m_litr2c_to_fire               => clm3%g%c%ccf%m_litr2c_to_fire
    m_litr3c_to_fire               => clm3%g%c%ccf%m_litr3c_to_fire
    cwdc_to_litr2c                 => clm3%g%c%ccf%cwdc_to_litr2c
    cwdc_to_litr3c                 => clm3%g%c%ccf%cwdc_to_litr3c
    litr1c_to_soil1c               => clm3%g%c%ccf%litr1c_to_soil1c
    litr2c_to_soil2c               => clm3%g%c%ccf%litr2c_to_soil2c
    litr3c_to_soil3c               => clm3%g%c%ccf%litr3c_to_soil3c
    nee                            => clm3%g%c%ccf%nee
    nep                            => clm3%g%c%ccf%nep
    nbp                            => clm3%g%c%ccf%nbp
    col_ar                         => clm3%g%c%ccf%pcf_a%ar
    col_gpp                        => clm3%g%c%ccf%pcf_a%gpp
    col_npp                        => clm3%g%c%ccf%pcf_a%npp
    col_pft_fire_closs             => clm3%g%c%ccf%pcf_a%pft_fire_closs
    col_litfall                    => clm3%g%c%ccf%pcf_a%litfall
    col_rr                         => clm3%g%c%ccf%pcf_a%rr
    col_vegfire                    => clm3%g%c%ccf%pcf_a%vegfire
    col_wood_harvestc              => clm3%g%c%ccf%pcf_a%wood_harvestc
    soil1_hr                       => clm3%g%c%ccf%soil1_hr
    soil2_hr                       => clm3%g%c%ccf%soil2_hr
    soil3_hr                       => clm3%g%c%ccf%soil3_hr
    soil4_hr                       => clm3%g%c%ccf%soil4_hr
    somfire                        => clm3%g%c%ccf%somfire
    somhr                          => clm3%g%c%ccf%somhr
    sr                             => clm3%g%c%ccf%sr
    totfire                        => clm3%g%c%ccf%totfire
    cwdc_hr                        => clm3%g%c%ccf%cwdc_hr
    cwdc_loss                      => clm3%g%c%ccf%cwdc_loss
    litterc_loss                   => clm3%g%c%ccf%litterc_loss
    ! dynamic landcover pointers
    dwt_closs                      => clm3%g%c%ccf%dwt_closs
    landuseflux                    => clm3%g%c%ccf%landuseflux
    landuptake                     => clm3%g%c%ccf%landuptake
    dwt_conv_cflux                 => clm3%g%c%ccf%dwt_conv_cflux
    seedc                          => clm3%g%c%ccs%seedc
    
    ! wood product pointers
    prod10c_loss                   => clm3%g%c%ccf%prod10c_loss
    prod100c_loss                  => clm3%g%c%ccf%prod100c_loss
    product_closs                  => clm3%g%c%ccf%product_closs
    ...
    col_totpftc                    => clm3%g%c%ccs%pcs_a%totpftc
    col_totvegc                    => clm3%g%c%ccs%pcs_a%totvegc
    ...
    agnpp                          => clm3%g%c%p%pcf%agnpp
    ar                             => clm3%g%c%p%pcf%ar
    bgnpp                          => clm3%g%c%p%pcf%bgnpp
    xsmrpool_to_atm                => clm3%g%c%p%pcf%xsmrpool_to_atm
    cpool_grain_gr                 => clm3%g%c%p%pcf%cpool_grain_gr
    cpool_grain_storage_gr         => clm3%g%c%p%pcf%cpool_grain_storage_gr
    cpool_to_grainc                => clm3%g%c%p%pcf%cpool_to_grainc
    grainc_xfer_to_grainc          => clm3%g%c%p%pcf%grainc_xfer_to_grainc
    transfer_grain_gr              => clm3%g%c%p%pcf%transfer_grain_gr
    ...
    grainc_storage                 => clm3%g%c%p%pcs%grainc_storage
    grainc_xfer                    => clm3%g%c%p%pcs%grainc_xfer
    cpool_deadcroot_gr             => clm3%g%c%p%pcf%cpool_deadcroot_gr
    cpool_deadcroot_storage_gr     => clm3%g%c%p%pcf%cpool_deadcroot_storage_gr
    cpool_deadstem_gr              => clm3%g%c%p%pcf%cpool_deadstem_gr
    cpool_deadstem_storage_gr      => clm3%g%c%p%pcf%cpool_deadstem_storage_gr
    cpool_froot_gr                 => clm3%g%c%p%pcf%cpool_froot_gr
    cpool_froot_storage_gr         => clm3%g%c%p%pcf%cpool_froot_storage_gr
    cpool_leaf_gr                  => clm3%g%c%p%pcf%cpool_leaf_gr
    cpool_leaf_storage_gr          => clm3%g%c%p%pcf%cpool_leaf_storage_gr
    cpool_livecroot_gr             => clm3%g%c%p%pcf%cpool_livecroot_gr
    cpool_livecroot_storage_gr     => clm3%g%c%p%pcf%cpool_livecroot_storage_gr
    cpool_livestem_gr              => clm3%g%c%p%pcf%cpool_livestem_gr
    cpool_livestem_storage_gr      => clm3%g%c%p%pcf%cpool_livestem_storage_gr
    ...
    current_gr                     => clm3%g%c%p%pcf%current_gr
    ...
    m_deadcrootc_storage_to_fire   => clm3%g%c%p%pcf%m_deadcrootc_storage_to_fire
    m_deadcrootc_storage_to_litter => clm3%g%c%p%pcf%m_deadcrootc_storage_to_litter
    m_deadcrootc_to_fire           => clm3%g%c%p%pcf%m_deadcrootc_to_fire
    m_deadcrootc_to_litter         => clm3%g%c%p%pcf%m_deadcrootc_to_litter
    m_deadcrootc_to_litter_fire    => clm3%g%c%p%pcf%m_deadcrootc_to_litter_fire
    m_deadcrootc_xfer_to_fire      => clm3%g%c%p%pcf%m_deadcrootc_xfer_to_fire
    m_deadcrootc_xfer_to_litter    => clm3%g%c%p%pcf%m_deadcrootc_xfer_to_litter
    m_deadstemc_storage_to_fire    => clm3%g%c%p%pcf%m_deadstemc_storage_to_fire
    m_deadstemc_storage_to_litter  => clm3%g%c%p%pcf%m_deadstemc_storage_to_litter
    m_deadstemc_to_fire            => clm3%g%c%p%pcf%m_deadstemc_to_fire
    m_deadstemc_to_litter          => clm3%g%c%p%pcf%m_deadstemc_to_litter
    m_deadstemc_to_litter_fire     => clm3%g%c%p%pcf%m_deadstemc_to_litter_fire
    m_deadstemc_xfer_to_fire       => clm3%g%c%p%pcf%m_deadstemc_xfer_to_fire
    m_deadstemc_xfer_to_litter     => clm3%g%c%p%pcf%m_deadstemc_xfer_to_litter
    m_frootc_storage_to_fire       => clm3%g%c%p%pcf%m_frootc_storage_to_fire
    m_frootc_storage_to_litter     => clm3%g%c%p%pcf%m_frootc_storage_to_litter
    m_frootc_to_fire               => clm3%g%c%p%pcf%m_frootc_to_fire
    m_frootc_to_litter             => clm3%g%c%p%pcf%m_frootc_to_litter
    m_frootc_xfer_to_fire          => clm3%g%c%p%pcf%m_frootc_xfer_to_fire
    m_frootc_xfer_to_litter        => clm3%g%c%p%pcf%m_frootc_xfer_to_litter
    m_gresp_storage_to_fire        => clm3%g%c%p%pcf%m_gresp_storage_to_fire
    m_gresp_storage_to_litter      => clm3%g%c%p%pcf%m_gresp_storage_to_litter
    m_gresp_xfer_to_fire           => clm3%g%c%p%pcf%m_gresp_xfer_to_fire
    m_gresp_xfer_to_litter         => clm3%g%c%p%pcf%m_gresp_xfer_to_litter
    m_leafc_storage_to_fire        => clm3%g%c%p%pcf%m_leafc_storage_to_fire
    m_leafc_storage_to_litter      => clm3%g%c%p%pcf%m_leafc_storage_to_litter
    m_leafc_to_fire                => clm3%g%c%p%pcf%m_leafc_to_fire
    m_leafc_to_litter              => clm3%g%c%p%pcf%m_leafc_to_litter
    m_leafc_xfer_to_fire           => clm3%g%c%p%pcf%m_leafc_xfer_to_fire
    m_leafc_xfer_to_litter         => clm3%g%c%p%pcf%m_leafc_xfer_to_litter
    m_livecrootc_storage_to_fire   => clm3%g%c%p%pcf%m_livecrootc_storage_to_fire
    m_livecrootc_storage_to_litter => clm3%g%c%p%pcf%m_livecrootc_storage_to_litter
    m_livecrootc_to_fire           => clm3%g%c%p%pcf%m_livecrootc_to_fire
    m_livecrootc_to_litter         => clm3%g%c%p%pcf%m_livecrootc_to_litter
    m_livecrootc_xfer_to_fire      => clm3%g%c%p%pcf%m_livecrootc_xfer_to_fire
    m_livecrootc_xfer_to_litter    => clm3%g%c%p%pcf%m_livecrootc_xfer_to_litter
    m_livestemc_storage_to_fire    => clm3%g%c%p%pcf%m_livestemc_storage_to_fire
    m_livestemc_storage_to_litter  => clm3%g%c%p%pcf%m_livestemc_storage_to_litter
    m_livestemc_to_fire            => clm3%g%c%p%pcf%m_livestemc_to_fire
    m_livestemc_to_litter          => clm3%g%c%p%pcf%m_livestemc_to_litter
    m_livestemc_xfer_to_fire       => clm3%g%c%p%pcf%m_livestemc_xfer_to_fire
    m_livestemc_xfer_to_litter     => clm3%g%c%p%pcf%m_livestemc_xfer_to_litter
    hrv_leafc_to_litter               => clm3%g%c%p%pcf%hrv_leafc_to_litter               
    hrv_leafc_storage_to_litter       => clm3%g%c%p%pcf%hrv_leafc_storage_to_litter     
    hrv_leafc_xfer_to_litter          => clm3%g%c%p%pcf%hrv_leafc_xfer_to_litter        
    hrv_frootc_to_litter              => clm3%g%c%p%pcf%hrv_frootc_to_litter            
    hrv_frootc_storage_to_litter      => clm3%g%c%p%pcf%hrv_frootc_storage_to_litter    
    hrv_frootc_xfer_to_litter         => clm3%g%c%p%pcf%hrv_frootc_xfer_to_litter       
    hrv_livestemc_to_litter           => clm3%g%c%p%pcf%hrv_livestemc_to_litter         
    hrv_livestemc_storage_to_litter   => clm3%g%c%p%pcf%hrv_livestemc_storage_to_litter 
    hrv_livestemc_xfer_to_litter      => clm3%g%c%p%pcf%hrv_livestemc_xfer_to_litter    
    hrv_deadstemc_to_prod10c          => clm3%g%c%p%pcf%hrv_deadstemc_to_prod10c        
    hrv_deadstemc_to_prod100c         => clm3%g%c%p%pcf%hrv_deadstemc_to_prod100c       
    hrv_deadstemc_storage_to_litter   => clm3%g%c%p%pcf%hrv_deadstemc_storage_to_litter 
    hrv_deadstemc_xfer_to_litter      => clm3%g%c%p%pcf%hrv_deadstemc_xfer_to_litter    
    hrv_livecrootc_to_litter          => clm3%g%c%p%pcf%hrv_livecrootc_to_litter        
    hrv_livecrootc_storage_to_litter  => clm3%g%c%p%pcf%hrv_livecrootc_storage_to_litter
    hrv_livecrootc_xfer_to_litter     => clm3%g%c%p%pcf%hrv_livecrootc_xfer_to_litter   
    hrv_deadcrootc_to_litter          => clm3%g%c%p%pcf%hrv_deadcrootc_to_litter        
    hrv_deadcrootc_storage_to_litter  => clm3%g%c%p%pcf%hrv_deadcrootc_storage_to_litter
    hrv_deadcrootc_xfer_to_litter     => clm3%g%c%p%pcf%hrv_deadcrootc_xfer_to_litter   
    hrv_gresp_storage_to_litter       => clm3%g%c%p%pcf%hrv_gresp_storage_to_litter     
    hrv_gresp_xfer_to_litter          => clm3%g%c%p%pcf%hrv_gresp_xfer_to_litter        
    hrv_xsmrpool_to_atm               => clm3%g%c%p%pcf%hrv_xsmrpool_to_atm             
    col_hrv_xsmrpool_to_atm           => clm3%g%c%ccf%pcf_a%hrv_xsmrpool_to_atm             
    mr                             => clm3%g%c%p%pcf%mr
    npp                            => clm3%g%c%p%pcf%npp
    pft_fire_closs                 => clm3%g%c%p%pcf%pft_fire_closs
    psnshade_to_cpool              => clm3%g%c%p%pcf%psnshade_to_cpool
    psnsun_to_cpool                => clm3%g%c%p%pcf%psnsun_to_cpool
    rr                             => clm3%g%c%p%pcf%rr
    storage_gr                     => clm3%g%c%p%pcf%storage_gr
    transfer_deadcroot_gr          => clm3%g%c%p%pcf%transfer_deadcroot_gr
    transfer_deadstem_gr           => clm3%g%c%p%pcf%transfer_deadstem_gr
    transfer_froot_gr              => clm3%g%c%p%pcf%transfer_froot_gr
    transfer_gr                    => clm3%g%c%p%pcf%transfer_gr
    transfer_leaf_gr               => clm3%g%c%p%pcf%transfer_leaf_gr
    transfer_livecroot_gr          => clm3%g%c%p%pcf%transfer_livecroot_gr
    transfer_livestem_gr           => clm3%g%c%p%pcf%transfer_livestem_gr
    vegfire                        => clm3%g%c%p%pcf%vegfire
    wood_harvestc                  => clm3%g%c%p%pcf%wood_harvestc
    frootc_alloc                   => clm3%g%c%p%pcf%frootc_alloc
    frootc_loss                    => clm3%g%c%p%pcf%frootc_loss
    leafc_alloc                    => clm3%g%c%p%pcf%leafc_alloc
    leafc_loss                     => clm3%g%c%p%pcf%leafc_loss
    woodc_alloc                    => clm3%g%c%p%pcf%woodc_alloc
    woodc_loss                     => clm3%g%c%p%pcf%woodc_loss
...
!      end if
   ...
   call p2c_1d(lbp, ubp, lbc, ubc, gpp, col_gpp, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, ar, col_ar, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, rr, col_rr, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, npp, col_npp, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, vegfire, col_vegfire, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, wood_harvestc, col_wood_harvestc, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, totvegc, col_totvegc, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, totpftc, col_totpftc, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, pft_fire_closs, col_pft_fire_closs, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, litfall, col_litfall, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, hrv_xsmrpool_to_atm, col_hrv_xsmrpool_to_atm, &
	    'unity')
...
!
! !INTERFACE:
subroutine NSummary(lbp, ubp, lbc, ubc, num_soilc, num_soilp)
!
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
    ! assign local pointers
    ivt                            => clm3%g%c%p%itype
    col_fire_nloss                 => clm3%g%c%cnf%col_fire_nloss
    denit                          => clm3%g%c%cnf%denit
    m_cwdn_to_fire                 => clm3%g%c%cnf%m_cwdn_to_fire
    m_litr1n_to_fire               => clm3%g%c%cnf%m_litr1n_to_fire
    m_litr2n_to_fire               => clm3%g%c%cnf%m_litr2n_to_fire
    m_litr3n_to_fire               => clm3%g%c%cnf%m_litr3n_to_fire
    col_pft_fire_nloss             => clm3%g%c%cnf%pnf_a%pft_fire_nloss
    sminn_to_denit_excess          => clm3%g%c%cnf%sminn_to_denit_excess
    sminn_to_denit_l1s1            => clm3%g%c%cnf%sminn_to_denit_l1s1
    sminn_to_denit_l2s2            => clm3%g%c%cnf%sminn_to_denit_l2s2
    sminn_to_denit_l3s3            => clm3%g%c%cnf%sminn_to_denit_l3s3
    sminn_to_denit_s1s2            => clm3%g%c%cnf%sminn_to_denit_s1s2
    sminn_to_denit_s2s3            => clm3%g%c%cnf%sminn_to_denit_s2s3
    sminn_to_denit_s3s4            => clm3%g%c%cnf%sminn_to_denit_s3s4
    sminn_to_denit_s4              => clm3%g%c%cnf%sminn_to_denit_s4
    cwdn                           => clm3%g%c%cns%cwdn
    litr1n                         => clm3%g%c%cns%litr1n
    litr2n                         => clm3%g%c%cns%litr2n
    litr3n                         => clm3%g%c%cns%litr3n
    col_totpftn                    => clm3%g%c%cns%pns_a%totpftn
    col_totvegn                    => clm3%g%c%cns%pns_a%totvegn
    ...
    m_deadcrootn_storage_to_fire   => clm3%g%c%p%pnf%m_deadcrootn_storage_to_fire
    m_deadcrootn_to_fire           => clm3%g%c%p%pnf%m_deadcrootn_to_fire
    m_deadcrootn_xfer_to_fire      => clm3%g%c%p%pnf%m_deadcrootn_xfer_to_fire
    m_deadstemn_storage_to_fire    => clm3%g%c%p%pnf%m_deadstemn_storage_to_fire
    m_deadstemn_to_fire            => clm3%g%c%p%pnf%m_deadstemn_to_fire
    m_deadstemn_xfer_to_fire       => clm3%g%c%p%pnf%m_deadstemn_xfer_to_fire
    m_frootn_storage_to_fire       => clm3%g%c%p%pnf%m_frootn_storage_to_fire
    m_frootn_to_fire               => clm3%g%c%p%pnf%m_frootn_to_fire
    m_frootn_xfer_to_fire          => clm3%g%c%p%pnf%m_frootn_xfer_to_fire
    m_leafn_storage_to_fire        => clm3%g%c%p%pnf%m_leafn_storage_to_fire
    m_leafn_to_fire                => clm3%g%c%p%pnf%m_leafn_to_fire
    m_leafn_xfer_to_fire           => clm3%g%c%p%pnf%m_leafn_xfer_to_fire
    m_livecrootn_storage_to_fire   => clm3%g%c%p%pnf%m_livecrootn_storage_to_fire
    m_livecrootn_to_fire           => clm3%g%c%p%pnf%m_livecrootn_to_fire
    m_livecrootn_xfer_to_fire      => clm3%g%c%p%pnf%m_livecrootn_xfer_to_fire
    m_livestemn_storage_to_fire    => clm3%g%c%p%pnf%m_livestemn_storage_to_fire
    m_livestemn_to_fire            => clm3%g%c%p%pnf%m_livestemn_to_fire
    m_livestemn_xfer_to_fire       => clm3%g%c%p%pnf%m_livestemn_xfer_to_fire
    m_retransn_to_fire             => clm3%g%c%p%pnf%m_retransn_to_fire
    hrv_deadstemn_to_prod10n         => clm3%g%c%p%pnf%hrv_deadstemn_to_prod10n        
    hrv_deadstemn_to_prod100n        => clm3%g%c%p%pnf%hrv_deadstemn_to_prod100n       
    ndeploy                        => clm3%g%c%p%pnf%ndeploy
    pft_fire_nloss                 => clm3%g%c%p%pnf%pft_fire_nloss
    ...
    grainn                         => clm3%g%c%p%pns%grainn
    grainn_storage                 => clm3%g%c%p%pns%grainn_storage
    grainn_xfer                    => clm3%g%c%p%pns%grainn_xfer
    ...
    ! dynamic landcover pointers
    wood_harvestn                  => clm3%g%c%p%pnf%wood_harvestn
    col_wood_harvestn              => clm3%g%c%cnf%pnf_a%wood_harvestn 
    dwt_nloss                      => clm3%g%c%cnf%dwt_nloss
    dwt_conv_nflux                 => clm3%g%c%cnf%dwt_conv_nflux
    prod10n_loss                   => clm3%g%c%cnf%prod10n_loss
    prod100n_loss                  => clm3%g%c%cnf%prod100n_loss
    product_nloss                  => clm3%g%c%cnf%product_nloss
...
!      end if
   ...
   ! use p2c routine to get selected column-average pft-level fluxes and states
   call p2c_1d(lbp, ubp, lbc, ubc, pft_fire_nloss, col_pft_fire_nloss, &
	    'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, wood_harvestn, col_wood_harvestn, &
	    'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, totvegn, col_totvegn, 'unity')
   call p2c_1d(lbp, ubp, lbc, ubc, totpftn, col_totpftn, 'unity')
