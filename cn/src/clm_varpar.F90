...
! maxpatch_glcmec  = max number of glacier_mec pfts (columns) in glacier_mec landunit
  ...
  integer, parameter :: mxveg          = 12     ! maximum number of VIC vegetation classes
...
! VIC-related constants
  integer, parameter :: max_bands = 10
  integer, parameter :: max_layers = 3
  integer, parameter :: max_nodes = 50
  integer, parameter :: max_veg = 12
