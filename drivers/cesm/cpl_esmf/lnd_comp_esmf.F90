...
!EOP
    ...
    call ESMF_AttributeSet(comp, "ShortName", "VIC", &
                           convention=convCIM, purpose=purpComp, rc=rc)
    call ESMF_AttributeSet(comp, "LongName", &
                           "Variable Infiltration Capacity Model", &
                           convention=convCIM, purpose=purpComp, rc=rc)
    call ESMF_AttributeSet(comp, "ReleaseDate", "2014", &
                           convention=convCIM, purpose=purpComp, rc=rc)
...
!
! !DESCRIPTION:
!     finalize method for the VIC land model
!
! !REVISION HISTORY:
!
! !INTERFACE: ------------------------------------------------------------------
