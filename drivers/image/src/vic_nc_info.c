...
// It may be better to read all this info (in vic_def.h and in vic_nc_info.c)
// from a configuration file that is part of the source code, i.e. not user
// configurable

// Much of the setup for this is already handled in output_list_utils.c, which
// we make use of here.
