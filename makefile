...
OBJS = vicNl.o cmd_proc.o check_files.o read_soilparam.o open_file.o \
       ...
       put_data.o polint.o initialize_global.o \
       make_out_data.o read_snowmodel.o read_sawd.o read_sawd_binary.o \
       ...
       write_debug.o dist_prec.o open_debug.o initialize_new_storm.o \
...
arno_evap.o:   	  arno_evap.c $(INCFILE)
	$(CC) -c arno_evap.c
make_out_data.o:   	  make_out_data.c $(INCFILE)
	$(CC) -c make_out_data.c
