...
create_output_list()
{
    ...
    strcpy(out_data[OUT_PET].varname, "OUT_PET");                      /* Potential evapotranspiration (= area-weighted sum of potential transpiration and potential soil evaporation). [mm] (ALMA_OUTPUT: [mm/s]) */
    ...
    strcpy(out_data[OUT_FCANOPY].varname, "OUT_FCANOPY");              /* fractional area covered by plant canopy [fraction] */
