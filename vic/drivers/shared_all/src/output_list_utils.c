...
set_output_met_data_info()
{
    ...
    strcpy(out_metadata[OUT_LAKE_ICE_FRACT].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_SWE].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_SWE_V].long_name,
    ...
    strcpy(out_metadata[OUT_SMFROZFRAC].long_name,
    ...
    strcpy(out_metadata[OUT_SMLIQFRAC].long_name,
    ...
    strcpy(out_metadata[OUT_SNOW_CANOPY].long_name,
    ...
    strcpy(out_metadata[OUT_SOIL_ICE_FRAC].long_name,
    ...
    strcpy(out_metadata[OUT_SOIL_LIQ_FRAC].long_name,
    ...
    strcpy(out_metadata[OUT_SOIL_WET].long_name,
    ...
    strcpy(out_metadata[OUT_SURFSTOR].long_name,
    ...
    strcpy(out_metadata[OUT_SURF_FROST_FRAC].long_name,
    ...
    strcpy(out_metadata[OUT_WDEW].long_name,
    ...
    strcpy(out_metadata[OUT_ZWT].long_name,
    ...
    strcpy(out_metadata[OUT_ZWT_LUMPED].long_name,
    ...
    strcpy(out_metadata[OUT_DELINTERCEPT].long_name,
    ...
    strcpy(out_metadata[OUT_DELSOILMOIST].long_name,
    ...
    strcpy(out_metadata[OUT_DELSURFSTOR].long_name,
    ...
    strcpy(out_metadata[OUT_EVAP_BARE].long_name,
    ...
    strcpy(out_metadata[OUT_EVAP_CANOP].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_BF_IN_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_BF_OUT_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_CHAN_IN].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_CHAN_IN_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_CHAN_OUT].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_CHAN_OUT_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_DSTOR].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_DSTOR_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_DSWE].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_DSWE_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_EVAP].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_EVAP_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_PREC_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_RCHRG].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_RO_IN].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_RO_IN_V].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_VAPFLX].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_VAPFLX_V].long_name,
    ...
    strcpy(out_metadata[OUT_PET].long_name,
    ...
    strcpy(out_metadata[OUT_REFREEZE].long_name,
    ...
    strcpy(out_metadata[OUT_SUB_BLOWING].long_name,
    ...
    strcpy(out_metadata[OUT_SUB_CANOP].long_name,
    ...
    strcpy(out_metadata[OUT_SUB_SNOW].long_name,
    ...
    strcpy(out_metadata[OUT_SUB_SURFACE].long_name,
    ...
    strcpy(out_metadata[OUT_BARESOILT].long_name,
    ...
    strcpy(out_metadata[OUT_LAKE_SURF_TEMP].long_name,
    ...
    strcpy(out_metadata[OUT_RAD_TEMP].long_name,
    ...
    strcpy(out_metadata[OUT_SNOW_SURF_TEMP].long_name,
    ...
    strcpy(out_metadata[OUT_SNOWT_FBFLAG].long_name,
    ...
    strcpy(out_metadata[OUT_SURFT_FBFLAG].long_name,
    ...
    strcpy(out_metadata[OUT_ADV_SENS].long_name,
    ...
    strcpy(out_metadata[OUT_DELTACC].long_name,
    ...
    strcpy(out_metadata[OUT_FUSION].long_name,
    ...
    strcpy(out_metadata[OUT_IN_LONG].long_name,
    ...
    strcpy(out_metadata[OUT_LATENT].long_name,
    ...
    strcpy(out_metadata[OUT_LATENT_SUB].long_name,
    ...
    strcpy(out_metadata[OUT_LWNET].long_name,
    ...
    strcpy(out_metadata[OUT_SWNET].long_name,
    ...
    strcpy(out_metadata[OUT_R_NET].long_name,
    ...
    strcpy(out_metadata[OUT_RFRZ_ENERGY].long_name,
    ...
    strcpy(out_metadata[OUT_SENSIBLE].long_name,
    ...
    strcpy(out_metadata[OUT_SNOW_FLUX].long_name,
    ...
    strcpy(out_metadata[OUT_AERO_COND1].long_name,
    ...
    strcpy(out_metadata[OUT_AERO_COND2].long_name,
    ...
    strcpy(out_metadata[OUT_AERO_RESIST1].long_name,
    ...
    strcpy(out_metadata[OUT_AERO_RESIST2].long_name,
    ...
    strcpy(out_metadata[OUT_CATM].long_name,
    ...
    strcpy(out_metadata[OUT_FDIR].long_name,
    ...
    strcpy(out_metadata[OUT_LWDOWN].long_name,
    ...
    strcpy(out_metadata[OUT_PAR].long_name,
    ...
    strcpy(out_metadata[OUT_SURF_COND].long_name,
    ...
    strcpy(out_metadata[OUT_APAR].long_name,
    ...
    strcpy(out_metadata[OUT_GPP].long_name,
    ...
    strcpy(out_metadata[OUT_RAUT].long_name,
    ...
    strcpy(out_metadata[OUT_NPP].long_name,
    ...
    strcpy(out_metadata[OUT_LITTERFALL].long_name,
    ...
    strcpy(out_metadata[OUT_NEE].long_name,
    ...
    strcpy(out_metadata[OUT_CINTER].long_name,
    ...
    strcpy(out_metadata[OUT_ADV_SENS_BAND].long_name,
           out_metadata[OUT_ADV_SENS].long_name);
    ...
    strcpy(out_metadata[OUT_ADVECTION_BAND].long_name,
           out_metadata[OUT_ADVECTION].long_name);
    ...
    strcpy(out_metadata[OUT_ALBEDO_BAND].long_name,
           out_metadata[OUT_ALBEDO].long_name);
    ...
    strcpy(out_metadata[OUT_DELTACC_BAND].long_name,
           out_metadata[OUT_DELTACC].long_name);
    ...
    strcpy(out_metadata[OUT_GRND_FLUX_BAND].long_name,
           out_metadata[OUT_GRND_FLUX].long_name);
    ...
    strcpy(out_metadata[OUT_IN_LONG_BAND].long_name,
           out_metadata[OUT_IN_LONG].long_name);
    ...
    strcpy(out_metadata[OUT_LATENT_BAND].long_name,
           out_metadata[OUT_LATENT].long_name);
    ...
    strcpy(out_metadata[OUT_LATENT_SUB_BAND].long_name,
           out_metadata[OUT_LATENT_SUB].long_name);
    ...
    strcpy(out_metadata[OUT_MELT_ENERGY_BAND].long_name,
           out_metadata[OUT_MELT_ENERGY].long_name);
    ...
    strcpy(out_metadata[OUT_LWNET_BAND].long_name,
           out_metadata[OUT_LWNET].long_name);
    ...
    strcpy(out_metadata[OUT_SWNET_BAND].long_name,
           out_metadata[OUT_SWNET].long_name);
    ...
    strcpy(out_metadata[OUT_RFRZ_ENERGY_BAND].long_name,
           out_metadata[OUT_RFRZ_ENERGY].long_name);
    ...
    strcpy(out_metadata[OUT_SENSIBLE_BAND].long_name,
           out_metadata[OUT_SENSIBLE].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_CANOPY_BAND].long_name,
           out_metadata[OUT_SNOW_CANOPY].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_COVER_BAND].long_name,
           out_metadata[OUT_SNOW_COVER].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_DEPTH_BAND].long_name,
           out_metadata[OUT_SNOW_DEPTH].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_FLUX_BAND].long_name,
           out_metadata[OUT_SNOW_FLUX].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_MELT_BAND].long_name,
           out_metadata[OUT_SNOW_MELT].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_PACKT_BAND].long_name,
           out_metadata[OUT_SNOW_PACK_TEMP].long_name);
    ...
    strcpy(out_metadata[OUT_SNOW_SURFT_BAND].long_name,
           out_metadata[OUT_SNOW_SURF_TEMP].long_name);
    ...
    strcpy(out_metadata[OUT_SWE_BAND].long_name,
           out_metadata[OUT_SWE].long_name);
