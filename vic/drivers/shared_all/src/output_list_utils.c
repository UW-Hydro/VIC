...
set_output_met_data_info()
{
    ...
    strcpy(out_metadata[OUT_LAKE_AREA_FRAC].standard_name, "lake_area_fraction");
    ...
    strcpy(out_metadata[OUT_ROOTMOIST].standard_name, "soil_moisture_in_root_zone");
    ...
    strcpy(out_metadata[OUT_SNOW_COVER].standard_name, "snow_cover_area_fraction");
    ...
    strcpy(out_metadata[OUT_SOIL_LIQ].standard_name, "soil_moisture_liquid_depth");
    ...
    strcpy(out_metadata[OUT_DELSWE].standard_name, "change_in_snow_lwe_thickness");
    ...
    strcpy(out_metadata[OUT_LAKE_BF_OUT].standard_name, "baseflow_outgoing_lake");
    ...
    strcpy(out_metadata[OUT_LAKE_ICE_TEMP].standard_name, "lake_ice_temperature");
    ...
    strcpy(out_metadata[OUT_SNOW_PACK_TEMP].standard_name, "snow_pack_temperature");
    ...
    strcpy(out_metadata[OUT_SOILT_FBFLAG].standard_name, "soil_temperature_flag");
    ...
    strcpy(out_metadata[OUT_TCAN_FBFLAG].standard_name, "canopy_temperature_flag");
    ...
    strcpy(out_metadata[OUT_TFOL_FBFLAG].standard_name, "foliage_temperature_flag");
    ...
    strcpy(out_metadata[OUT_DELTAH].standard_name, "rate_change_in_heat_storage");
    ...
    strcpy(out_metadata[OUT_GRND_FLUX].standard_name, "downward_heat_flux_in_soil");
    ...
    strcpy(out_metadata[OUT_AERO_COND].standard_name, "aerodynamic_conductance");
    ...
    strcpy(out_metadata[OUT_AERO_RESIST].standard_name, "aerodynamic_resistance");
    ...
    strcpy(out_metadata[OUT_FCANOPY].standard_name, "canopy_cover_area_fraction");
    ...
    strcpy(out_metadata[OUT_VPD].standard_name, "water_vapor_saturation_deficit");
