...
set_state_meta_data_info()
{
    ...
    strcpy(state_metadata[STATE_SOIL_MOISTURE].standard_name, "soil_layer_moisture");
    strcpy(state_metadata[STATE_SOIL_MOISTURE].units, "mm");
    strcpy(state_metadata[STATE_SOIL_MOISTURE].description, "soil total moisture contents including ice for each soil layer");

    // STATE_SOIL_ICE
    strcpy(state_metadata[STATE_SOIL_ICE].varname, "STATE_SOIL_ICE");
    strcpy(state_metadata[STATE_SOIL_ICE].long_name, "soil_ice");
    strcpy(state_metadata[STATE_SOIL_ICE].standard_name, "soil_moisture_ice_depth");
    strcpy(state_metadata[STATE_SOIL_ICE].units, "mm");
    strcpy(state_metadata[STATE_SOIL_ICE].description, "soil ice content for each soil layer");
    ...
    strcpy(state_metadata[STATE_CANOPY_WATER].description, "amount of water stored in the vegetation canopy");

    // STATE_ANNUALNPP
    strcpy(state_metadata[STATE_ANNUALNPP].varname, "STATE_ANNUALNPP");
    strcpy(state_metadata[STATE_ANNUALNPP].long_name, "annualnpp");
    strcpy(state_metadata[STATE_ANNUALNPP].standard_name, "running_total_annual_NPP");
    strcpy(state_metadata[STATE_ANNUALNPP].units, "g m-2");
    strcpy(state_metadata[STATE_ANNUALNPP].description, "running total annual NPP");
    ...
    strcpy(state_metadata[STATE_ANNUALNPPPREV].standard_name, "previous_year_total_annual_NPP");
    strcpy(state_metadata[STATE_ANNUALNPPPREV].units, "g m-2");
    strcpy(state_metadata[STATE_ANNUALNPPPREV].description, "total annual NPP from previous year");

    // STATE_CLITTER
    strcpy(state_metadata[STATE_CLITTER].varname, "STATE_CLITTER");
    strcpy(state_metadata[STATE_CLITTER].long_name, "clitter");
    strcpy(state_metadata[STATE_CLITTER].standard_name, "carbon_in_litter_pool");
    strcpy(state_metadata[STATE_CLITTER].units, "g m-2");
    strcpy(state_metadata[STATE_CLITTER].description, "carbon storage in litter pool");

    // STATE_CINTER
    strcpy(state_metadata[STATE_CINTER].varname, "STATE_CINTER");
    strcpy(state_metadata[STATE_CINTER].long_name, "cinter");
    strcpy(state_metadata[STATE_CINTER].standard_name, "carbon_in_intermediate_pool");
    strcpy(state_metadata[STATE_CINTER].units, "g m-2");
    strcpy(state_metadata[STATE_CINTER].description, "carbon storage in intermediate pool");

    // STATE_CSLOW
    strcpy(state_metadata[STATE_CSLOW].varname, "STATE_CSLOW");
    strcpy(state_metadata[STATE_CSLOW].long_name, "cslow");
    strcpy(state_metadata[STATE_CSLOW].standard_name, "carbon_in_slow_pool");
    strcpy(state_metadata[STATE_CSLOW].units, "g m-2");
    strcpy(state_metadata[STATE_CSLOW].description, "carbon storage in slow pool");

    // STATE_SNOW_AGE
    strcpy(state_metadata[STATE_SNOW_AGE].varname, "STATE_SNOW_AGE");
    strcpy(state_metadata[STATE_SNOW_AGE].long_name, "snow_age");
    strcpy(state_metadata[STATE_SNOW_AGE].standard_name, "age_since_last_new_snow");
    strcpy(state_metadata[STATE_SNOW_AGE].units, "model_time_step");
    strcpy(state_metadata[STATE_SNOW_AGE].description, "number of model time steps since the last new snow");
    ...
    strcpy(state_metadata[STATE_SNOW_MELT_STATE].standard_name, "snow_melting_phase");
    strcpy(state_metadata[STATE_SNOW_MELT_STATE].units, "none");
    strcpy(state_metadata[STATE_SNOW_MELT_STATE].description, "flag to indicate whether snowpack is in accumulation or melting phase");
    ...
    strcpy(state_metadata[STATE_SNOW_COVERAGE].standard_name, "snow_coverage_fraction");
    strcpy(state_metadata[STATE_SNOW_COVERAGE].units, "none");
    strcpy(state_metadata[STATE_SNOW_COVERAGE].description, "fraction of grid cell area covered by snow");
    ...
    strcpy(state_metadata[STATE_SNOW_WATER_EQUIVALENT].standard_name, "snow_water_equivalent");
    strcpy(state_metadata[STATE_SNOW_WATER_EQUIVALENT].units, "m");
    strcpy(state_metadata[STATE_SNOW_WATER_EQUIVALENT].description, "snow water equivalent");
    ...
    strcpy(state_metadata[STATE_SNOW_SURF_TEMP].standard_name, "snow_surface_temperature");
    strcpy(state_metadata[STATE_SNOW_SURF_TEMP].units, "C");
    strcpy(state_metadata[STATE_SNOW_SURF_TEMP].description, "snow surface layer temperature");
    ...
    strcpy(state_metadata[STATE_SNOW_SURF_WATER].standard_name, "snow_surface_liquid_water");
    strcpy(state_metadata[STATE_SNOW_SURF_WATER].units, "m");
    strcpy(state_metadata[STATE_SNOW_SURF_WATER].description, "liquid water content of the snow surface layer");
    ...
    strcpy(state_metadata[STATE_SNOW_PACK_TEMP].standard_name, "snow_pack_temperature");
    strcpy(state_metadata[STATE_SNOW_PACK_TEMP].units, "C");
    strcpy(state_metadata[STATE_SNOW_PACK_TEMP].description, "snow pack layer temperature");
    ...
    strcpy(state_metadata[STATE_SNOW_PACK_WATER].standard_name, "snow_pack_liquid_water");
    strcpy(state_metadata[STATE_SNOW_PACK_WATER].units, "m");
    strcpy(state_metadata[STATE_SNOW_PACK_WATER].description, "liquid water content of the snow pack layer");
    ...
    strcpy(state_metadata[STATE_SNOW_DENSITY].standard_name, "snowpack_density");
    ...
    strcpy(state_metadata[STATE_SNOW_COLD_CONTENT].standard_name, "snowpack_cold_content");
    strcpy(state_metadata[STATE_SNOW_COLD_CONTENT].units, "J/m2");
    strcpy(state_metadata[STATE_SNOW_COLD_CONTENT].description, "snowpack cold content");
    ...
    strcpy(state_metadata[STATE_SNOW_CANOPY].standard_name, "snow_water_equivalent_intercepted_in_canopy");
    strcpy(state_metadata[STATE_SNOW_CANOPY].units, "m");
    strcpy(state_metadata[STATE_SNOW_CANOPY].description, "snow interception storage in canopy");
    ...
    strcpy(state_metadata[STATE_SOIL_NODE_TEMP].standard_name, "soil_node_temperature");
    strcpy(state_metadata[STATE_SOIL_NODE_TEMP].units, "C");
    strcpy(state_metadata[STATE_SOIL_NODE_TEMP].description, "soil temperature of each soil thermal node");
    ...
    strcpy(state_metadata[STATE_FOLIAGE_TEMPERATURE].standard_name, "foliage_temperature");
    strcpy(state_metadata[STATE_FOLIAGE_TEMPERATURE].units, "C");
    strcpy(state_metadata[STATE_FOLIAGE_TEMPERATURE].description, "overstory vegetaion temperature");
    ...
    strcpy(state_metadata[STATE_ENERGY_LONGUNDEROUT].standard_name, "longwave_out_from_understory");
    strcpy(state_metadata[STATE_ENERGY_LONGUNDEROUT].units, "W/m2");
    strcpy(state_metadata[STATE_ENERGY_LONGUNDEROUT].description, "outgoing longwave flux from understory vegetation");
    ...
    strcpy(state_metadata[STATE_ENERGY_SNOW_FLUX].standard_name, "snowpack_thermal_flux");
    strcpy(state_metadata[STATE_ENERGY_SNOW_FLUX].units, "W/m2");
    strcpy(state_metadata[STATE_ENERGY_SNOW_FLUX].description, "thermal flux through snowpack");
    ...
    strcpy(state_metadata[STATE_LAKE_SOIL_MOISTURE].standard_name, "lake_soil_moisture");
    strcpy(state_metadata[STATE_LAKE_SOIL_MOISTURE].units, "mm");
    strcpy(state_metadata[STATE_LAKE_SOIL_MOISTURE].description, "soil moisture below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_SOIL_ICE].standard_name, "lake_soil_ice_content");
    strcpy(state_metadata[STATE_LAKE_SOIL_ICE].units, "mm");
    strcpy(state_metadata[STATE_LAKE_SOIL_ICE].description, "soil ice content below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_CLITTER].standard_name, "lake_carbon_in_litter_pool");
    strcpy(state_metadata[STATE_LAKE_CLITTER].units, "g m-2");
    strcpy(state_metadata[STATE_LAKE_CLITTER].description, "carbon storage in litter pool below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_CINTER].standard_name, "lake_carbon_in_intermediate_pool");
    strcpy(state_metadata[STATE_LAKE_CINTER].units, "g m-2");
    strcpy(state_metadata[STATE_LAKE_CINTER].description, "carbon storage in intermediate pool below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_CSLOW].standard_name, "lake_carbon_in_slow_pool");
    strcpy(state_metadata[STATE_LAKE_CSLOW].units, "g m-2");
    strcpy(state_metadata[STATE_LAKE_CSLOW].description, "carbon storage in slow pool below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_AGE].standard_name, "lake_age_since_last_new_snow");
    strcpy(state_metadata[STATE_LAKE_SNOW_AGE].units, "model_time_step");
    strcpy(state_metadata[STATE_LAKE_SNOW_AGE].description, "number of model time steps since the last new snow on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_MELT_STATE].standard_name, "lake_snow_melting_phase");
    strcpy(state_metadata[STATE_LAKE_SNOW_MELT_STATE].units, "none");
    strcpy(state_metadata[STATE_LAKE_SNOW_MELT_STATE].description, "flag to indicate whether snowpack is in accumulation or melting phase on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_COVERAGE].standard_name, "lake_snow_coverage_fraction");
    strcpy(state_metadata[STATE_LAKE_SNOW_COVERAGE].units, "none");
    strcpy(state_metadata[STATE_LAKE_SNOW_COVERAGE].description, "fraction of grid cell area covered by snow on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_WATER_EQUIVALENT].standard_name, "snow_water_equivalent");
    strcpy(state_metadata[STATE_LAKE_SNOW_WATER_EQUIVALENT].units, "m");
    strcpy(state_metadata[STATE_LAKE_SNOW_WATER_EQUIVALENT].description, "snow water equivalent on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_TEMP].standard_name, "lake_snow_surface_temperature");
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_TEMP].description, "snow surface layer temperature on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_WATER].standard_name, "lake_snow_surface_temperature");
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_WATER].units, "m");
    strcpy(state_metadata[STATE_LAKE_SNOW_SURF_WATER].description, "liquid water content of the snow surface layer on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_TEMP].standard_name, "lake_snow_pack_temperature");
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_TEMP].description, "snow pack layer temperature on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_WATER].standard_name, "lake_snow_surface_liquid_water");
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_WATER].units, "m");
    strcpy(state_metadata[STATE_LAKE_SNOW_PACK_WATER].description, "liquid water content of the snow surface layer on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_DENSITY].standard_name, "lake_snowpack_density");
    strcpy(state_metadata[STATE_LAKE_SNOW_DENSITY].units, "kg/m3");
    strcpy(state_metadata[STATE_LAKE_SNOW_DENSITY].description, "snowpack density on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_COLD_CONTENT].standard_name, "lake_snowpack_cold_content");
    strcpy(state_metadata[STATE_LAKE_SNOW_COLD_CONTENT].units, "J/m2");
    strcpy(state_metadata[STATE_LAKE_SNOW_COLD_CONTENT].description, "snowpack cold content_on_lake_ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SNOW_CANOPY].standard_name, "snow_water_equivalent_intercepted_in_canopy");
    strcpy(state_metadata[STATE_LAKE_SNOW_CANOPY].units, "m");
    strcpy(state_metadata[STATE_LAKE_SNOW_CANOPY].description, "snow interception storage in canopy on lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_SOIL_NODE_TEMP].standard_name, "lake_soil_node_temperature");
    strcpy(state_metadata[STATE_LAKE_SOIL_NODE_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_SOIL_NODE_TEMP].description, "soil temperature of each soil thermal node below lake");
    ...
    strcpy(state_metadata[STATE_LAKE_ACTIVE_LAYERS].standard_name, "lake_active_layers");
    strcpy(state_metadata[STATE_LAKE_ACTIVE_LAYERS].units, "none");
    strcpy(state_metadata[STATE_LAKE_ACTIVE_LAYERS].description, "number of nodes whose corresponding layers currently contain water");
    ...
    strcpy(state_metadata[STATE_LAKE_LAYER_DZ].standard_name, "lake_thickness_layer_below_surface");
    strcpy(state_metadata[STATE_LAKE_LAYER_DZ].units, "m");
    strcpy(state_metadata[STATE_LAKE_LAYER_DZ].description, "vertical thickness of all horizontal lake water layers below the surface layer");
    ...
    strcpy(state_metadata[STATE_LAKE_SURF_LAYER_DZ].standard_name, "lake_thickness_surface_layer");
    strcpy(state_metadata[STATE_LAKE_SURF_LAYER_DZ].units, "m");
    strcpy(state_metadata[STATE_LAKE_SURF_LAYER_DZ].description, "vertical thickness of surface water layer in lake");
    ...
    strcpy(state_metadata[STATE_LAKE_DEPTH].standard_name, "lake_liquid_water_depth");
    strcpy(state_metadata[STATE_LAKE_DEPTH].units, "m");
    strcpy(state_metadata[STATE_LAKE_DEPTH].description, "distance from surface to deepest point in lake");
    ...
    strcpy(state_metadata[STATE_LAKE_LAYER_SURF_AREA].standard_name, "lake_node_surface_area");
    strcpy(state_metadata[STATE_LAKE_LAYER_SURF_AREA].units, "m2");
    strcpy(state_metadata[STATE_LAKE_LAYER_SURF_AREA].description, "surface area of liquid water in lake at each node");
    ...
    strcpy(state_metadata[STATE_LAKE_SURF_AREA].standard_name, "lake_surface_area");
    strcpy(state_metadata[STATE_LAKE_SURF_AREA].units, "m2");
    strcpy(state_metadata[STATE_LAKE_SURF_AREA].description, "surface area of liquid plus ice water on lake surface");
    ...
    strcpy(state_metadata[STATE_LAKE_VOLUME].description, "lake total volume including liquid water equivalent of lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_LAYER_TEMP].standard_name, "lake_layer_temp");
    strcpy(state_metadata[STATE_LAKE_LAYER_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_LAYER_TEMP].description, "lake water temperature at each node");
    ...
    strcpy(state_metadata[STATE_LAKE_AVERAGE_TEMP].standard_name, "lake_average_temperature");
    strcpy(state_metadata[STATE_LAKE_AVERAGE_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_AVERAGE_TEMP].description, "average liquid water temperature of entire lake");

    // STATE_LAKE_ICE_AREA_FRAC
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC].varname, "STATE_LAKE_ICE_AREA");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC].long_name, "lake_ice_area");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC].standard_name, "lake_ice_coverage");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC].units, "m2");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC].description, "area of ice coverage on lake at beginning of time step");

    // STATE_LAKE_ICE_AREA_FRAC_NEW
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC_NEW].varname, "STATE_LAKE_ICE_AREA_NEW");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC_NEW].long_name, "lake_ice_area_new");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC_NEW].standard_name, "lake_ice_area_new");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC_NEW].units, "m2");
    strcpy(state_metadata[STATE_LAKE_ICE_AREA_FRAC_NEW].description, "area of ice coverage on lake at end of time step");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_WATER_EQUIVALENT].standard_name, "lake_ice_water_equivalent");
    strcpy(state_metadata[STATE_LAKE_ICE_WATER_EQUIVALENT].units, "m3");
    strcpy(state_metadata[STATE_LAKE_ICE_WATER_EQUIVALENT].description, "liquid water equivalent volume of lake ice");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_HEIGHT].standard_name, "lake_ice_height_thickest");
    strcpy(state_metadata[STATE_LAKE_ICE_HEIGHT].units, "m");
    strcpy(state_metadata[STATE_LAKE_ICE_HEIGHT].description, "lake ice height at ghickest point");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_TEMP].standard_name, "lake_ice_temperature");
    strcpy(state_metadata[STATE_LAKE_ICE_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_ICE_TEMP].description, "lake ice temperature");

    // STATE_LAKE_ICE_SWE
    strcpy(state_metadata[STATE_LAKE_ICE_SWE].varname, "STATE_LAKE_ICE_SWE");
    strcpy(state_metadata[STATE_LAKE_ICE_SWE].long_name, "lake_ice_swe");
    strcpy(state_metadata[STATE_LAKE_ICE_SWE].standard_name, "lake_snow_water_equivalent");
    strcpy(state_metadata[STATE_LAKE_ICE_SWE].units, "m");
    strcpy(state_metadata[STATE_LAKE_ICE_SWE].description, "liquid water equivalent depth of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_TEMP].standard_name, "lake_snow_surface_temperature");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_TEMP].description, "temperature of snow surface layer of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_TEMP].standard_name, "lake_ice_snow_pack_temperature");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_TEMP].units, "C");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_TEMP].description, "temperature of snow pack layer of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_COLD_CONTENT].standard_name, "lake_ice_snow_cold_content");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_COLD_CONTENT].units, "J/m2");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_COLD_CONTENT].description, "snowpack cold content of snow lake");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_WATER].standard_name, "lake_ice_snow_surface_liquid_water");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_WATER].units, "m");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_SURF_WATER].description, "liquid water content of surface snow layer of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_WATER].standard_name, "lake_ice_snow_pack_liquid_water");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_WATER].units, "m");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_PACK_WATER].description, "liquid water content of pack snow layer of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_ALBEDO].standard_name, "lake_ice_snow_albedo");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_ALBEDO].units, "none");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_ALBEDO].description, "albedo of lake snow");
    ...
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_DEPTH].standard_name, "lake_ice_snow_depth");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_DEPTH].units, "m");
    strcpy(state_metadata[STATE_LAKE_ICE_SNOW_DEPTH].description, "depth of snow on lake ice");
}
