...
// remove: double adjflux(double, double, double ,double, double, double, double,
...
// remove: void alloc_atmos(int, atmos_data_struct **);
...
// remove (also remove from drivers/classic/src/initialize_lake.c): int get_depth_from_sarea(lake_con_struct, double, double *);
...
// remove (also remove from drivers/classic/src/initialize_lake.c): int ice_depth(lake_con_struct, double, double, double *);
